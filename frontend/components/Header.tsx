...
const Header: React.FC<HeaderProps> = ({ onNavigate, onFormOpen }) => {
  ...
  return (
    <header className="bg-[#F9FAFB] py-4 px-4 sm:px-6 lg:px-16 sticky top-0 z-50 border-b border-gray-200">
      ...
      {isMenuOpen && (
        <div className="lg:hidden absolute top-full left-0 right-0 bg-[#F9FAFB] shadow-lg z-40">
          <nav className="flex flex-col items-center space-y-4 text-md font-bold p-4">
            {navLinks}
